      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            {/* Public signing link — both paths for compatibility */}
            ...
            <Route path="/sign/:id" element={<ProtectedRoute><SignaturePlacement /></ProtectedRoute>} />
            <Route path="/audit/:id" element={<ProtectedRoute><AuditTrail /></ProtectedRoute>} />
            <Route path="/recipients/:id" element={<ProtectedRoute><Recipients /></ProtectedRoute>} />
          </Routes>
        </BrowserRouter>
      </AuthProvider>
    );
