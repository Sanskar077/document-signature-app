                        ...
                        <div style={{ flex: 1, paddingTop: 8 }}>
                          ...
                          {Object.keys(m).length > 0 && (
                            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                              {m.originalName && typeof m.originalName === "string" && <MetadataChip label="file" value={m.originalName} />}
                              {m.fileName && !m.originalName && typeof m.fileName === "string" && <MetadataChip label="file" value={m.fileName} />}
                              {m.role && typeof m.role === "string" && <MetadataChip label="role" value={m.role} />}
                              {m.signatureCount && <MetadataChip label="signatures" value={String(m.signatureCount)} />}
                              {m.outputFileName && typeof m.outputFileName === "string" && <MetadataChip label="output" value={m.outputFileName} />}
                            </div>
                          )}
